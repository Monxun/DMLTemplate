...
def index(request):
    ...
    # if request.htmx:
    #     return render(request, 'charts/partials/gdp-bar.html', context)
    return render(request, 'charts/bar.html', context)
...
def line(request):
    ...
    # if request.htmx:
    #     return render(request, 'charts/partials/gdp-bar.html', context)
    return render(request, 'charts/line.html', context)
...
def multi(request):
    ...
    # if request.htmx:
    #     return render(request, 'charts/partials/gdp-bar.html', context) 
    return render(request, 'charts/multiline.html', context)